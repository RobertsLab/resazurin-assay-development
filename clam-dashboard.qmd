...
plotOrMessage = normalizedUnavailable
  ? md`**Normalized fluorescence unavailable for this selection.** Add a layout.txt with blank wells marked (is_blank = TRUE), then rebuild dashboard data.`
  : Plot.plot({
      height: 420,
      style: {
        color: "#111827",
