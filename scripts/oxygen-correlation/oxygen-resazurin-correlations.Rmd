...
plot1<-df%>%
  ...
  ggplot(aes(x=R.umol.mm.min, y=resazurin_total))+
  geom_point(color="darkgray")+
  geom_smooth(method="lm", color="black")+
  xlab(expression(paste("Oxygen consumption (µmol O" [2], "mm" ^-1, ")")))+
  ylab(expression(paste("Fold change fluorescence mm" ^-1)))+
  geom_text(label="p=0.012", x=4e-04, y=0.8)+
  theme_classic(); plot1
