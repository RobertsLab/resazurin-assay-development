...
remove<-c("20250610 plate2 21 B02", "20250601 plate1 32 B05", "20250601 plate1 32 B02")
...
plot1<-full_data%>%
  ...
  stat_smooth(aes(group=temperature), method="lm")+
  theme_classic()+
  xlab("Hour");plot1
...
plot6a<-full_data%>%
  ...
  geom_text(aes(x=6.5, y=35), label="p<0.001")+
  labs(
    title = "",
