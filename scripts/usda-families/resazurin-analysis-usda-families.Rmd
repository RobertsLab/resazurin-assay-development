...
abline(h = mean(diff_values), col = "red")  # mean bias
abline(h = mean(diff_values) + 1.96 * sd(diff_values), col = "blue", lty = 2)
abline(h = mean(diff_values) - 1.96 * sd(diff_values), col = "blue", lty = 2)

lines(lowess(mean_values, diff_values), col = "darkorange", lwd = 2)
```
