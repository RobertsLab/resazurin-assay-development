`output/clam/20260401-clam-Day2-36C-C-vs-S`
...
`scripts/clam/00.00-resazurin-20260401-clam-Day2-36C-C-vs-S.Rmd`.
All tabular files are comma-separated values (CSV).

This is Day 2 of the experiment begun on 2026-03-31
(`20260331-clam-36C-C-vs-S`). Clams were returned to 36°C after overnight
cold-room recovery; fluorescence was measured hourly rather than every 30 min.

See `data/clam/20260401-clam-Day2-36C-C-vs-S/README.md` for experimental
context.
