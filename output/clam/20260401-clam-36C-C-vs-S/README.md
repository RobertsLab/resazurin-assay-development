`output/clam/20260401-clam-36C-C-vs-S`
...
`scripts/clam/00.00-resazurin-20260401-clam-36C-C-vs-S.Rmd`.
All tabular files are comma-separated values (CSV).

**Note:** Plate G was excluded by the plate consistency check (T0 was
accidentally scanned as a 24-well plate instead of 12-well). Results in this
directory do not include Plate G data.

See `data/clam/20260401-clam-36C-C-vs-S/README.md` for experimental context.
